...
// Nov. 2019
#ifndef __CamFlirFlyCapture_H__
#define  __CamFlirFlyCapture_H__
...
template<typename T>
class CamFlirFlyCapture
{
public:

  CamFlirFlyCapture(int wdth, int heigh, int dpth, int camID = 0, void *filename=NULL): depth(dpth)
  {
  ...
  {
    cout << "CamFlirFlyCapture::setAutoWhiteBalance not implemented" << endl;
  /*        double empty;
          double on = set ? 1 : 0;
  ...
  */
  ...
  {
    cout << "CamFlirFlyCapture::setAutoGain not implemented" << endl;
  /*
          double empty;
          double on = set ? 1 : 0;
